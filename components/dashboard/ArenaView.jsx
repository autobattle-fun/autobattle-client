  ...
  return (
    <main className="flex-1 relative flex items-center justify-center bg-black overflow-hidden p-6">
      ...
      >
        ...
        <h2 className="text-3xl md:text-4xl font-black font-mono text-white mb-2 glitch-text tracking-widest" data-text="ARENA VIEW">ARENA VIEW</h2>
        <p className="text-gray-400 font-mono text-sm mb-8">SIMULATION RUNNING • WAITING FOR RENDERER</p>
